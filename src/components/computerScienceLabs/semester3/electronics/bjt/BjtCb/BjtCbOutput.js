...
const BjtCbImg = "https://res.cloudinary.com/a-lab/image/upload/v1628739375/old-experiments-images/bjt-cb-in_xwjec6.png" ;

function BjtCbOutput() {
  ...
  return (
    <div className="bjt-cb-in">
      ...
      <div className="bjt-cb-in-bg-img-div">
          <img src={BjtCbImg} width={1080} height={700} />
        <input
          type="text"
