...
export const BottomNav = () => {
  return (
    <div className="fixed z-10 left-[2%] top-[88vh] justify-center items-center flex rounded-[10px] h-[10vh]  w-[96vw] bg-white  shadow    sm:hidden  ">
      <div className="flex">
        <a
          className="w-full font-thin uppercase text-blue-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start  dark:from-gray-700 dark:to-gray-800 "
          href="/"
        >
